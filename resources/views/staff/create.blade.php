    ...
    <div class="col-md-3 mt-2">
        ...
        <select name="supervisor_no" class="form-control">
            ...
            @foreach($supervisors as $sup)
                <option value="{{ $sup->staff_no }}" {{ old('supervisor_no') == $sup->staff_no ? 'selected' : '' }}>
...
<div class="row g-2">
    <div class="col-md-4">
        ...
        <input type="text" name="kin_full_name" class="form-control" value="{{ old('kin_full_name') }}">
    </div>
    <div class="col-md-3">
        <label>Relationship</label>
        <input type="text" name="kin_relationship" class="form-control" value="{{ old('kin_relationship') }}">
    </div>
    <div class="col-md-3">
        <label>Street</label>
        <input type="text" name="kin_street" class="form-control" value="{{ old('kin_street') }}">
    </div>
    <div class="col-md-3 mt-2">
        <label>City</label>
        <input type="text" name="kin_city" class="form-control" value="{{ old('kin_city') }}">
    </div>
    <div class="col-md-3 mt-2">
        <label>Tel No</label>
        <input type="text" name="kin_tel_no" class="form-control" value="{{ old('kin_tel_no') }}">
    </div>
</div>
